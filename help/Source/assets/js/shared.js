...
if (ntshared == -1) {
	var moniker= "ms-its:";                  
    var sSharedCHM = moniker+"winmine.chm::/assets/";         
	}													
else
	{
...
var sAssetsBase = sSharedCHM;
var sDataBase = sAssetsBase + "data/";
var sImgBase = sAssetsBase + "img/";
var sCssBase = sAssetsBase + "css/";
...
if (isIE4){
	...
	var sSharedCHM= moniker+"winmine.chm::/assets/";
	sAssetsBase = sSharedCHM;
	sDataBase = sAssetsBase + "data/";
	sImgBase = sAssetsBase + "img/";
	sCssBase = sAssetsBase + "css/";
}
...
if(!isIE4){
    ...
    xmldoc.async = false;
	xmldoc.load(sDataBase + "alttext.xml");
...
var xmldom = new ActiveXObject("microsoft.XMLDOM");
	...
	try { xmldom.setProperty("SelectionLanguage", "XPath"); } catch(e) {}
...
var closed = sImgBase + "plusCold.gif";			//image used for collapsed item in callExpand()
var closedHot = sImgBase + "plusHot.gif";			//hot image used for collapsed item in callExpand()
var expand = sImgBase + "minusCold.gif";			//image used for expanded item in callExpand()
var expandHot = sImgBase + "minusHot.gif";		//hot image used for expanded item in callExpand()

var previousCold= sImgBase + "previousCold.gif";
var previousHot= sImgBase + "previousHot.gif"; 
var nextCold= sImgBase + "nextCold.gif";
var nextHot= sImgBase + "nextHot.gif"; 

var shortcutCold= sImgBase + "shortcutCold.gif";
var shortcutHot= sImgBase + "shortcutHot.gif";

var popupCold= sImgBase + "popupCold.gif";
var popupHot= sImgBase + "popupHot.gif";

var emptyImg= sImgBase + "empty.gif";		//image used for empty expand
var noteImg= sImgBase + "note.gif";			//image used for notes
var tipImg= sImgBase + "tip.gif";			//image used for tips
var warningImg= sImgBase + "warning.gif";		//image used for warnings
var cautionImg= sImgBase + "caution.gif";		//image used for cautions
var importantImg= sImgBase + "important.gif";		//image used for important notice
var relTopicsImg= sImgBase + "rel_top.gif";		//image used for important notice

var branchImg= sImgBase + "elle.gif";
var branchImg_RTL= sImgBase + "elle_rtl.gif";
...
var sSharedReusableTextFile= sDataBase + "reusable.xml";									// common reusable text file
...
function list_them(){
	...
	var envelope = sImgBase +'envelope.gif';
...
var sIndex,sText=" ",sFile,sFileID,dataBindingObject;
	 ...
	 var e= eventSrc;
	 var eHref = "";
	 if (e && e.href) eHref = e.href;
	 var eH= unescape(eHref);
	 eH = eH.toLowerCase();
	 ...
	 if (iTOPIC==-1) {
		 if (e && e.getAttribute) {
			 sParamTOPIC = e.getAttribute("data-topic");
			 if (!sParamTOPIC || sParamTOPIC=="") {
				 sParamTOPIC = e.getAttribute("data-topic", 2);
			 }
		 }
		 if (!sParamTOPIC || sParamTOPIC=="") return;
	 } else {
		...
		if(node!=null)
			...
			while (o < seealsos.length){
				...
				if (o == 0) {
					...
					sIndex = "<A ID='wPopup' HREF='topic=" + sIndex + "' data-topic='" + sIndex + "' bite_me='1'>" + sTerm + "</a>"
					}
				else
					{
					sIndex = ", <A ID='wPopup' HREF='topic=" + sIndex + "' data-topic='" + sIndex + "' bite_me='1'>" + sTerm + "</a>"
			...
			if ((isIE55 || isIE6) && found){
				...
				var oPopup = window.createPopup();
 				var strScript = "<script language='JScript'> function clickPopup(){if (event.srcElement.tagName.toLowerCase() == 'a') parent.callPopup(event.srcElement); window.PopObject.hide(); return false;}</script>";
				...
				oPopup.document.createStyleSheet(sCssBase + "coUA.css");	// Apply the stylesheet.
